...
public class BrainCurves extends PApplet {
...
//    line((i-1),y0,i,y1);
    ...
    curveVertex((width*i),  height/8*i*y0*.033f);
    curveVertex(width*i*y1*0.25f,  height);
    curveVertex(0, 0);
    curveVertex(0, 0);
////  curveVertex(32, 100);
  endShape();  
...
//  println("Fru: " + fru);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "BrainCurves" };
    if (passedArgs != null) {
